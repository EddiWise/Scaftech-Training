    ...
    <div className="w-full bg-[#0a192f] text-white">
      ...
      <section className="relative w-full h-[400px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-5">
          ...
          <p className="mt-4 text-base md:text-lg text-gray-300">
            <span className="font-bold text-[#0a192f]">Slogan:</span> Building
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        ...
        <p className="text-sm md:text-base text-gray-300 leading-relaxed mt-6 text-justify">
          ...
          knowledge and practical skills to safely erect, inspect, and dismantle
          scaffolding in line with industry standards. Emphasis is on stability,
          load capacity, fall protection, and hazard prevention, ensuring zero
          compromise on safety when working at height.
        </p>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-8">
        ...
        <ul className="list-disc list-inside mt-4 space-y-2 text-gray-300">
          ...
          <li>Appropriate PPE for training sessions</li>
      ...
      <section className="max-w-5xl mx-auto px-6 py-8">
        ...
        <ul className="list-disc list-inside mt-4 space-y-2 text-gray-300">
          ...
          <li>Master fall prevention, load limits, and tagging protocols</li>
          <li>Ensure compliance with scaffold standards</li>
        </ul>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 py-8">
        <h3 className="text-xl md:text-2xl font-semibold text-[#07bc0c]">
          List of Courses Under Scaffold Training
        </h3>
        <ul className="list-disc list-inside mt-4 space-y-2 text-gray-300">
